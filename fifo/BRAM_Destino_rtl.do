transcript on
# =============================================================================
# Script de Simulação para o Testbench da BRAM_Destino
# =============================================================================
...
echo "Compilando BRAM_Destino e testbench..."
vcom -2008 BRAM_Destino.vhd
vcom -2008 BRAM_Destino_tb.vhd

# 3. Inicia o simulador no testbench
echo "Iniciando a simulação..."
vsim -voptargs=+acc -L altera_mf work.bram_destino_tb

# 4. Adiciona os sinais à janela de Wave para depuração
add wave -divider "Clock e Controle"
add wave sim:/bram_destino_tb/clk
add wave sim:/bram_destino_tb/wren

add wave -divider "Endereços e Dados"
add wave -radix unsigned sim:/bram_destino_tb/address
add wave -radix hex sim:/bram_destino_tb/data_in
add wave -radix hex sim:/bram_destino_tb/data_out

add wave -divider "Instância da BRAM"
add wave -radix unsigned sim:/bram_destino_tb/uut/address
add wave sim:/bram_destino_tb/uut/wren
add wave -radix hex sim:/bram_destino_tb/uut/data
add wave -radix hex sim:/bram_destino_tb/uut/q
