...
/**
 * @file user_hw.h
 * @brief Hardware register interface for traffic light control to interface with Qsys component.
 * 
 ...
 */
static inline uint32_t user_hw_get_base(uint8_t semaphore_id) {
 ...
 */
static inline void user_hw_enable_irq(uint8_t semaphore_id) {
    uint32_t base = user_hw_get_base(semaphore_id);
 ...
 */
static inline void user_hw_clear_irq(uint8_t semaphore_id) {
    uint32_t base = user_hw_get_base(semaphore_id);
 ...
 */
static inline void user_hw_write_red_time(uint8_t semaphore_id, uint32_t seconds) {
    uint32_t base = user_hw_get_base(semaphore_id);
 ...
 * @param seconds Time in seconds (0-999).
 */
static inline void user_hw_write_yellow_time(uint8_t semaphore_id, uint32_t seconds) {
    uint32_t base = user_hw_get_base(semaphore_id);
 ...
 * @param seconds Time in seconds (0-999).
 */
static inline void user_hw_write_green_time(uint8_t semaphore_id, uint32_t seconds) {
    uint32_t base = user_hw_get_base(semaphore_id);
 ...
 */
static inline void user_hw_write_control(uint8_t semaphore_id, uint32_t start, uint32_t stop, uint32_t initial_state) {
    uint32_t base = user_hw_get_base(semaphore_id);
    uint32_t control = 0;
 ...
 */
static inline uint32_t user_hw_read_status(uint8_t semaphore_id) {
    uint32_t base = user_hw_get_base(semaphore_id);
 ...
 */
static inline uint32_t user_hw_read_remaining_time(uint8_t semaphore_id) {
    uint32_t base = user_hw_get_base(semaphore_id);
 ...
 */
static inline uint32_t user_hw_get_state(uint32_t status) {
 ...
 */
static inline uint32_t user_hw_is_running(uint32_t status) {
